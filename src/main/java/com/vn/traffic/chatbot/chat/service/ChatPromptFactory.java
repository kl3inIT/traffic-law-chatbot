...
public class ChatPromptFactory {
    ...
    public String buildPrompt(String question, GroundingStatus groundingStatus, List<CitationResponse> citations) {
        ...
        return String.join("\n",
                ...
                "Tất cả các khóa conclusion, answer, uncertaintyNotice, legalBasis, penalties, requiredDocuments, procedureSteps, nextSteps, scenarioFacts, scenarioRule, scenarioOutcome, scenarioActions phải luôn xuất hiện trong JSON.",
                ...
                "Trả về JSON hợp lệ với đúng các khóa sau: conclusion, answer, uncertaintyNotice, legalBasis, penalties, requiredDocuments, procedureSteps, nextSteps, scenarioFacts, scenarioRule, scenarioOutcome, scenarioActions.",
